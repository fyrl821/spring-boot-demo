...
/**
 * Function Description: 2020-6-20自己创建的redis配置类 <br>
 * Writter: PL <br>
 * Creating Time: 2020-06-20 11:00 <br>
 **/
@Configuration
@EnableCaching
public class MyRedisConfig extends CachingConfigurerSupport {

    // spring-boot 2.0的写法，在1.0中可以RedisCacheManager cacheManager = new RedisCacheManager(redisTemplate)
//    @Bean
...
//    }
    ...
    public RedisTemplate<String, User> userRedisTemplate(RedisConnectionFactory factory) {
        ...
        // value值的序列化采用fastJSonRedisSerizer
